				...
				return this.each(function() {
					...
					if (options.thumbs) {
						...
						data.thumbs.on('mouseover.lax', function(e){
							$(this).stop().animate({bottom:options.thumbAnimate+4+'px'},options.thumbAnimateTime);
						}).on('mouseout.lax',function(){
							$(this).stop().animate({bottom:'4px'}, options.thumbAnimateTime);
